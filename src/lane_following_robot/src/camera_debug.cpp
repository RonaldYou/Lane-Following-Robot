...
CameraDebug::CameraDebug(): Node("camera_debug"), image_count_(0){
    ...
    image_sub_ = it.subscribe("/camera/image_raw", 1, std::bind(&CameraDebug::image_callback, this, std::placeholders::_1));
...
void CameraDebug::image_callback(const sensor_msgs::msg::Image::SharedPtr msg){
